	...
	function _update(index, data, keypress) {
		...
		if (!isSelected) {
			...
			if (data.multiple) {
				...
				data.$selected.html('<span class="selecter-selected-text">' + newLabel + '</span><span class="selecter-button"></span>');
